...
//            System.out.println(head.val);
    ...
    public boolean hasCycle(Node head) {
        ...
        while (fast != null && fast.next != null) {
            ...
            fast = fast.next.next;
            if (slow == fast) {
                return true;   // Slow and fast pointers meet if cycle exists
            }
        }
        return false;
    }
    ...
    public Node detectCycle(Node head) {
        ...
        // After meeting, take one pointer back to head and now both should move 1 at a time. They would eventually meet up
        slow = head;
        while (slow != fast) {
            slow = slow.next;
            fast = fast.next;
    ...
    public Node getIntersectionNode(Node headA, Node headB) {
        Node pointerA = headA;
        Node pointerB = headB;
        // When a pointer reaches the end, switch to other list. They will eventually meet. This will give us the answer.
